			...
			<div class="card-body">
				<form action="" id="manage-venue">
					...
					<div class="form-group">
						...
						<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)" accept="image/x-png,image/gif,image/jpeg,image/png" style="display: none">
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-sm btn-block btn-theme col-sm-2"> Save</button>
						</div>
					</div>
				</form>
			</div>
